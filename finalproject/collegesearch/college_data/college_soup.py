...
@task(log_stdout=True,nout=4,result=LocalResult(serializer=PandasSerializer(file_type='csv'),dir='./',location="college_data.csv"))
...
@task(log_stdout=True, nout=4, result=LocalResult(serializer=PandasSerializer(file_type='csv'), dir='./', location="wiki_list.csv"))
def create_wiki(facts, bypass):
    ...
    return wiki_list
@task(log_stdout=True,nout=4,result=LocalResult(serializer=PandasSerializer(file_type='csv'),dir='./',location="embedding_dict.csv"))
